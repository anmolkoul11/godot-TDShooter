...
var _peek_fire_timer: float = 0.0
var _retreat_spawn_position: Vector2 = Vector2.ZERO
var _wants_cover: bool = false        # NEW: set when bullets/damage make us seek cover
